...
import ScratchBlocks from 'highq-blocks';
...
export default function (blockId) {
    // Not sure any better way to access the highq-blocks workspace than this...
    ...
    return new Promise(resolve => {
        setTimeout(() => {
            ...
            computedStyleToInlineStyle(svg, {
                ...
                // Specifically properties that are set from CSS in highq-blocks
